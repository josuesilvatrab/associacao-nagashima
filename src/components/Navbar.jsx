        ...
        <main className="max-w-7xl mx-auto px-4 py-6">
              ...
              <section className="relative rounded-2xl bg-gradient-to-r from-zinc-900 via-zinc-900 to-red-950/40 border border-zinc-800 p-6 sm:p-12 flex flex-col md:flex-row items-center justify-between gap-8 shadow-2xl overflow-hidden">
                <div className="max-w-2xl space-y-4 text-center md:text-left">
                  ...
                  <div className="space-y-1">
                    <h1 className="text-2xl sm:text-4xl md:text-5xl font-black uppercase text-white tracking-wider" style={{ fontFamily: "'Shojumaru', cursive, serif" }}>
                  ...
                  <h2 className="text-sm sm:text-xl md:text-2xl font-bold uppercase tracking-tight text-zinc-200 pt-2">
                ...
                <div className="w-36 h-36 sm:w-52 sm:h-52 md:w-64 md:h-64 rounded-full border-4 border-red-600 bg-white p-2 shadow-2xl flex-shrink-0">
                  <img src={configSede.bannerLogo || logoImg} alt="Logo Banner" className="w-full h-full object-contain rounded-full" />
                </div>
              </section>

              {avisos.length > 0 && (
                <section className="bg-zinc-900 border border-red-600/30 rounded-2xl p-4 sm:p-6 shadow-xl space-y-4">
                      ...
                      <div key={a.id} onClick={() => toggleExpandirAtleta(a.id)} className={`bg-zinc-900 border ${isExpanded ? 'border-red-600' : 'border-zinc-800'} rounded-2xl p-4 sm:p-5 transition-all duration-300 shadow-xl cursor-pointer overflow-hidden`}>
                        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                          <div className="flex items-center gap-3 sm:gap-4 w-full sm:w-auto">
                            ...
                            <div className="space-y-1">
                              <h3 className="font-extrabold text-base sm:text-lg text-white">{a.nome}</h3>
          ...
          {activePage === 'eventos' && (
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                {eventos.map(e => (
                  <div key={e.id} className="bg-zinc-900 border border-zinc-800 rounded-xl p-4 sm:p-6 space-y-3 shadow-xl">
          ...
          {activePage === 'exames' && (
            <div className="space-y-6">
              ...
              <div className="space-y-6">
                {exames.map(ex => (
                  <div key={ex.id} className="bg-zinc-900 border border-zinc-800 rounded-2xl p-5 sm:p-6 space-y-4 shadow-xl">
